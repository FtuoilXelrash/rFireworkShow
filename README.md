...
[![Version](https://img.shields.io/badge/Version-1.0.10-green.svg)](https://github.com/FtuoilXelrash/rFireworksShow)
...
- **🎨 Random Colors** - Each firework randomly selects from 7 vibrant colors (Champagne, Green, Blue, Violet, Red, Orange, White)
...
- **Colors**: Each firework independently selects a random color from the 7 available options
